...
function setup() {
  ...
  playBtn = new Button(canvasWidth/2 - canvasWidth/12, canvasHeight  - canvasWidth*2/9,
...
function draw() {
  ...
  if(gameStatus == 0){
    image(underline, canvasWidth/4, canvasHeight/8, canvasWidth/2, canvasWidth/16);

    image(playersImg[0], canvasWidth*3/8, canvasHeight/2-canvasWidth/7, canvasWidth/4, canvasWidth/7);
    image(playersImg[1], canvasWidth/8, canvasHeight/2-canvasWidth/11, canvasWidth/8, canvasWidth/11);
    image(playersImg[2], canvasWidth*6/8, canvasHeight/2-canvasWidth/11, canvasWidth/8, canvasWidth/11);
