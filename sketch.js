...
function menuView(){
  ...
  text(pizzaNames[choosenPizza], canvasWidth/2-canvasWidth/6, canvasHeight/2+canvasWidth/22+canvasWidth/32, canvasWidth/3, canvasWidth/16)
  ...
  arrowLeft.display(canvasWidth*3/16 + (arrowLeft.over() ? arrowMove : 0), canvasHeight/2+canvasWidth/22+canvasWidth/32, canvasWidth/8, canvasWidth/16);
  arrowRight.display(canvasWidth*11/16 + (arrowRight.over() ? arrowMove : 0), canvasHeight/2+canvasWidth/22+canvasWidth/32, canvasWidth/8, canvasWidth/16);
