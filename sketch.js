...
function setup() {
  ...
  arrowLeft  = new Button(canvasWidth/3, canvasHeight/2+canvasWidth/22,  arrowLeftImg, canvasWidth/8, canvasWidth/11)
  arrowRight  = new Button(canvasWidth*13/24, canvasHeight/2+canvasWidth/22,  arrowRightImg, canvasWidth/8, canvasWidth/11)
