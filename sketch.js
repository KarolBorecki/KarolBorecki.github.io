...
function draw() {
  ...
  if(gameStatus == 0){
    ...
    for(var i = 0; i<5; i++){
      if(i<4)image(okImg, (canvasWidth/6 + canvasWidth/6*(i)), canvasHeight/2-canvasWidth/7, canvasWidth/15, canvasWidth/15);
      image(ingredientsImg[playersIngredients[choosenPizza][i]], (canvasWidth/12 + canvasWidth/6*i), canvasHeight/2-canvasWidth/12, canvasWidth/6, canvasWidth/6);
    }
