...
function draw() {
  ...
  if(gameStatus == 0){
    ...
    textAlign(CENTER);
    text(points, canvasWidth - canvasWidth/7, canvasWidth/28, canvasWidth/6, canvasWidth/7);
    image(pointsFrame, canvasWidth - canvasWidth/7, 0, canvasWidth/6, canvasWidth/7);
